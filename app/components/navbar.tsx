...
export default function Navbar() {
    ...
    return (
        <div className="h-14 flex justify-center pointer-events-none items-center fixed z-50 start-0 end-0 lg:bottom-10">
            <nav className="flex flex-col pointer-events-auto backdrop-blur-md p-2 px-6 rounded-full shadow-none lg:bg-stone-950/50 lg:shadow-[0_0px_18px_10px_rgba(0,0,0,0.3)]">
