...
export default function Logo({size, className, style} : {size?: number, className?: string, style?: CSSProperties} ) {
    return (
        <svg width={size ?? "260"} height={size ?? "260"} viewBox="0 0 217 217" className={className} style={style}>
