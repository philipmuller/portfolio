...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-between bg-[#5B5540]">
      <div className="w-full h-full p-8 flex basis-1 flex-1 flex-col gap-6">

        <div className="w-full items-center grow shrink justify-between font-mono text-sm overflow-hidden rounded-2xl">
          <Spline onScroll={onScroll} scene="https://prod.spline.design/vOTSy200mmfodOdw/scene.splinecode"/>
        </div>

        <div className='flex flex-col px-6 pb-10 z-10 gap-1'>
          <h1 className='text-lg font-medium tracking-widest uppercase'>Organon</h1>
          <p className='text-xs font-light opacity-80'>Write and learn formal logic like never before, designed for iPhone.</p>
        </div>
